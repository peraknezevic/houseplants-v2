...
export const plantSchema = z.object({
  ...
  commonNames: z.string().min(3).max(250).optional().nullish().or(z.literal("")),
  ...
  imageCredits: z.string().min(3).max(200).optional().nullish().or(z.literal("")),
...
export const plantProfileSchema = z.object({
  ...
  zalivanje: z.string().optional().nullish().or(z.literal("")),
  soil: z.string().or(z.literal("")),
  supstrat: z.string().optional().nullish().or(z.literal("")),
  soilPH: z.string().or(z.literal("")),
  humidity: z.enum(["LOW", "MEDIUM", "HIGH"]).optional(),
  feeding: z.string().or(z.literal("")),
  prihrana: z.string().optional().nullish().or(z.literal("")),
  minimalT: z.number(),
  optimalT: z.number(),
  speedOfGrowth: z.enum(["SLOW", "MODERATE", "FAST"]).optional(),
  matureSize: z.string().or(z.literal("")),
  velicina: z.string().nullish().or(z.literal("")),
  repotting: z.string().or(z.literal("")),
  presadjivanje: z.string().nullish().or(z.literal("")),
  flower: z.string().or(z.literal("")),
  cvet: z.string().nullish().or(z.literal("")),
  propagation: z.string().or(z.literal("")),
  razmnozavanje: z.string().nullish().or(z.literal("")),
  toxicity: z.enum(["TOXIC", "NOT_TOXIC", "NO_INFO"]).optional(),
  pests: z.string().or(z.literal("")),
  stetocine: z.string().nullish().or(z.literal("")),
  diseases: z.string().or(z.literal("")),
  bolesti: z.string().nullish().or(z.literal("")),
  imageCredits: z.string().nullish().or(z.literal("")),
  notes: z.string().nullish().or(z.literal("")),
  beleske: z.string().nullish().or(z.literal("")),
